  ...
  return (
    <>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="font-display text-2xl text-navy-900">Library Collection</h2>
          <p className="mt-1 text-sm text-navy-400">
            Books the library owns and lends out. Only admins can add to this shelf.
          </p>
        </div>
        <button
          onClick={openAdd}
...
export default AdminCollectionTab;
